...
?>
    ...
    <ul>
    	<li class="li1">
    		<a href="<?php echo getenv('SITE_ADRESS') ?>/t1.php">Селекторы CSS.</a>
    	</li>
       <li class="li1">
    		<a href="<?php echo getenv('SITE_ADRESS') ?>/t2.php">Справочник CSS.</a>
    	</li>
        <li class="li1">
            <a href="<?php echo getenv('SITE_ADRESS') ?>/t3.php">CSS каскадирование,специфичность,наследование.</a>
        </li>
    </ul>
