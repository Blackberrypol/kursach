...
<?php
$sel = "SELECT * FROM `articles2`ORDER BY id DESC ";
...
while($row = mysqli_fetch_array($qrydisplay)){
 ...
 "<a style='background-color:##e0c1f3'href='page_t2.php?open=$id'>Открыть</a><br><br>
 </div>";
}
?>
</div>
